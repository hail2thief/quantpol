...
You will pick one of the datasets below, download the adjoining Rmarkdown template, and complete the following activities outlined there: 
...
tribble(~variable, ~meaning, 
        ...
        "np1", "Did respondent attend community meeting?", 
        ...
        "l1", "Ideology (1 = far left, 10 = far right)") %>% 
  kable() %>% 
    column_spec(2, width = "20em")
```
