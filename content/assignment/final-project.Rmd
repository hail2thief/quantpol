...
One of the big changes that World War II brought about in the US was bringing women into the labor force in massive numbers. Over time, involvement of women in economic and political life also changed dramatically. 
...
tribble(~variable, ~meaning, 
        ...
        "polity2", "Democracy score, ranging from full autocracy (-10) to full democracy (10).") %>% 
  kable() %>% 
...
- effect of democracy on military spending 
...
tribble(~variable, ~meaning, 
        ...
        "alliesties", "Number of ties a group's allies have", 
...
tribble(~variable, ~meaning, 
        ...
        "usally", "1 if cold war alliance with USA at any point",
...
- does a Western education spread democracy to other countries? 
- does a Western education make alliances with the US more likely? 
- does having lots of students studying abroad in the US make US alliances more likely? 
...
Many people in the world become victims of crime at some point or another in their lives. These experiences can be highly traumatic. How does criminal victimization change people and their attitudes and beliefs?


This dataset comes from [LAPOP](https://www.vanderbilt.edu/lapop/), and the [codebook](https://www.vanderbilt.edu/lapop/ab2018/AB2018-V12.0-Eng_190131_W.pdf). The data is a survey of people living across a dozen countries in Latin America, their experiences with crime, and their attitudes towards democracy, how the state should respond to crime, and so on. 
...
- does being a victim of a crime increase support for military coups? 
- does being a victim of a crime increase support for vigilante justice? 
...
The appointment and confirmation of judges to the Supreme Court is an increasingly important and politicized process in the current climate of high polarization. Do politicians, in voting to confirm a Supreme Court nominee, respond to public pressure? Or do they act more autonomously? 
...
tribble(~variable, ~meaning, 
        ...
        "nom_ideology", "Nominee's ideology, on a -1 (liberal) to +1 (conservative) scale", 
...
This data comes from the [2019 Democracy Fund Voter Study Group](https://www.voterstudygroup.org/publication/2019-voter-survey-full-data-set). The data is a survey of Americans, and includes  information on racial prejudice, demographics, ideology, and support for welfare policies. 
...
This data comes from [The Center for Economic Development at the University of Los Andes, in Colombia](https://economia.uniandes.edu.co/cede). 
