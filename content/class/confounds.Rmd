...
This "being led astray" by data is what we call **confounding**. What we want to do in this part of the class is use causal models to figure out how to estimate the effect of X on Y, *without confounding*. 
...
Front-door paths are *direct* causal flow from X to Y. They might be direct (as in an arrow from X to Y), or indirect, as in an arrow from X, to Z, to Y. We want to keep front doors open and **not** accidentally control for them. 
