...
Alternative - find moments, situations, or weird, freak occurrences where some group were exposed to some **treatment** while another group was not


the reason one group got the **treatment**, and other didn't, is purely by *chance* (just like with an experiment)
...
# Other examples: Nobel Prize winner
...
.pull-left[
```{r, out.width="80%"}
knitr::include_graphics("images/min-wage-model.png")
```
]

.pull-right[
```{r, out.width="80%"}
knitr::include_graphics("images/pa-nj-nobel.jpg")
```
]
