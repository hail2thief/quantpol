...
<!-- The new variable `ounces` = *pounds* times 16 (16 oz in a pound) -->
...
<!-- 1. Calculate the difference in vote share between Dems and Republicans in 2016 and convert it to a **percent**. Plot the distribution of this variable as a histogram. -->

<!-- 2. Construct a variable that tells you the percent of the population in a county that is neither Black nor white. Make a plot of some kind with this data. -->

<!-- 3. Construct a variable that measures a county's population *density* (population divided by area). What is the most and least densely populated county in the country?  -->
