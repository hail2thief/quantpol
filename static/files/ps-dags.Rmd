...
**Q1: if we were to control for M here, and then looked at the relationship between X and Y, what would that relationship be capturing?** 



Keeping the **fundamental problem of causality** in mind, think about a researcher that wants to test whether international trade between two countries makes them more or less likely to form defensive alliances. 
...
What do you need to adjust for here to properly estimate the effect of dogs on health? 
...
**Q5: Which of the following sets of variables could you control for?** 
...
Double-bonus: repeat the steps above for a different table on Wikipedia (suggestions below). Whether you finish this one or another, post on Slack so I can see. 
